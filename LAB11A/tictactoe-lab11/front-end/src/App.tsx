...
class App extends React.Component<Props, GameState> {
  ...
  constructor(props: Props) {
     ...
     */
    this.state = { cells: [], instructions: '', canUndo: false }
  }
  ...
  render(): React.ReactNode {
    ...
    return (
      <div>
        ...
        <div id="bottombar">
          <button className="action-btn" onClick={/* get the function, not call the function */this.newGame}>New Game</button>
          <button className="action-btn" onClick={this.undo} disabled={!this.state.canUndo}>Undo</button>
        </div>
      </div>
    );
  }
